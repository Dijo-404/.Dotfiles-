...
This file lists the contributors to the 404 project and their roles.
...
Note: New contributors should only add themselves to the Collaborators or Testers sections. Promotion to write access is determined by project maintainers based on the criteria in [TEAM_ROLES.md](https://github.com/404-Project/404/blob/master/TEAM_ROLES.md).
