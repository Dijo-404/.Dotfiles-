...
[![de](https://img.shields.io/badge/lang-de-black.svg)](Source/docs/Hyprdots-to-404.de.md)
[![中文](https://img.shields.io/badge/lang-中文-orange.svg)](Source/docs/Hyprdots-to-404.zh.md)
[![es](https://img.shields.io/badge/lang-es-yellow.svg)](Source/docs/Hyprdots-to-404.es.md)
...
> **NOTE**: If you're confused why every `install.sh -r` overwrites your configs, you should fork [404](https://github.com/404-Project/404), edit the `*.lst` file, and run the script. That’s the intended way.
...
- [ ] **Portable**
  ...
  - [ ] 404-specific files should be imported into $USER, not the other way around
  - [x] Keep it minimal
  - [ ] Make it packageable
  - [x] Follow XDG specs
  - [ ] Add Makefile
...
Here's how we can update 404-specific Hyprland settings without changing user preferences. We don't need the "userprefs" file. Instead, we can source 404's `hyprland.conf` and make $USER preferred changes directly in the config. With this approach, won't potentially break 404 and 404 won't break your own dots.
...
> - "404, your Development Environment" - khing

**Feel free to suggest your own meaning of 404. 🤔**
