...
看这里了解完整说明：
[404 之旅：起源与未来蓝图](./Hyprdots-to-404.zh.md)
...
404 是一个高度自定义的预设，在其他[桌面环境](https://wiki.archlinux.org/title/Desktop_environment)/[窗口管理器](https://wiki.archlinux.org/title/Window_manager)的上安装 404 也许可行，但它可能会与您的[GTK](https://wiki.archlinux.org/title/GTK)/[Qt](https://wiki.archlinux.org/title/Qt) 主题, [Shell](https://wiki.archlinux.org/title/Command-line_shell), [SDDM](https://wiki.archlinux.org/title/SDDM), [GRUB](https://wiki.archlinux.org/title/GRUB)等等配置相冲突.您需自行承担风险。

我们支持 NixOS， 但作为一个单独的仓库在 [404nix](https://github.com/richen604/404nix/tree/main) 提供。
...
> [!TIP]
> 您可以在 `Scripts/pkg_user.lst` 中添加您想随 404 一同安装的应用，并将此文件作为参数传入安装脚本，像这样：
>
> ```shell
...
在安装脚本运行完成后请重启，首次启动时您将看到 SDDM 登录界面（或者黑屏）。更多细节请看[安装 wiki](https://github.com/404-Project/404/wiki/installation)
...
要更新 404, 您需要从 GitHub 中拉取最新更改并通过运行以下命令恢复配置：
...
详情请见[404-Project/404-themes](https://github.com/404-Project/404-themes)。
...
> 如果您想展示您的 404 主题，或者您想寻找非官方主题，请看[kRHYME7/404-gallery](https://github.com/kRHYME7/404-gallery)。
